    ...
    <>
      <div className="w-[70rem] h-[43rem] my-[1rem] border-[1px] bg-[#ffff] dark:bg-gray-800 rounded-2xl shadow-2xl grid grid-col-3 grid-rows-3 gap-4">
        ...
        <div className="w-[10rem] h-[10rem] rounded-lg shadow-xl border-[1px] bg-[#FBF6F6] dark:bg-gray-700 row-start-3 mr-[33.5rem] mt-[2.5rem]">
          <div className="relative size-40 flex flex-col">
            <svg
            ...
            >
              ...
              <circle
                ...
                r="16"
                fill="none"
                className="stroke-current text-[#12926c] dark:text-green-500"
                stroke-width="2"
            ...
            <div className="absolute top-[4.5rem] right-4 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <span className="text-4xl font-bold text-[#22445d] dark:text-green-500">
