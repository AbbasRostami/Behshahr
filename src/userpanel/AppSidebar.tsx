...
import { RiProfileFill, RiReservedFill } from "react-icons/ri";
import { BiBookHeart, BiChevronDown, BiComment } from "react-icons/bi";
...
const navItems: NavItem[] = [
  ...
  },
  {
    name: "دوره های رزرو",
    icon: <RiReservedFill />,
    path: "/my-courses-reserve",
  },
  {
    name: "دوره های موردعلاقه",
    icon: <MdFavorite />,
